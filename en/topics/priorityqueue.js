...
0</pre></div>
            ...
            hints: [
                ...
                { title: 'But there\'s a problem with this', content: 'Finding the max in an array = <strong>O(N)</strong>, removing it is also <strong>O(N)</strong>.<br>With up to 100,000 operations, doing O(N) each time means <strong>100K x 100K = 10 billion operations</strong>... TLE!<br><br>Insertion is fast, but <strong>scanning everything on each extraction is the bottleneck</strong>.' },

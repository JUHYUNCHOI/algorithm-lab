...
\
            ...
            <div class="concept-section">\
                ...
                <div class="analogy-box">\
                    <strong>Understanding by analogy:</strong> 여러분의 <strong>가족 관계도</strong>를 떠올려 보세요!<br><br>\
...
\
            ...
            <div class="concept-section">\
                ...
                <div class="analogy-box">\
                    <strong>Understanding by analogy:</strong> <strong>"예/아니오 퀴즈"</strong>를 생각해 보세요!<br><br>\
...
\
            ...
            <div class="concept-section">\
                ...
                <div class="analogy-box">\
                    <strong>Understanding by analogy:</strong> <strong>미술관 관람</strong>을 생각해 보세요!<br><br>\
    ...
    problems: [
            ...
            solutions: [{
                ...
                codeSteps: {
                    python: [
                        ...
                        { title: 'Return Result', desc: '현재 노드(+1)와 자식 중 더 깊은 쪽을 합치면 전체 깊이가 된다.', code: 'return 1 + max(left, right)' }
                    ],
                    cpp: [
                        ...
                        { title: 'Return Result', desc: '현재 노드(+1) + 자식 중 큰 깊이 = 전체 최대 깊이.', code: 'return 1 + max(left, right);' }
                    ]
                },
        ...
        // ===== 2단계: 트리 응용 =====
        {
            ...
            solutions: [{
                ...
                codeSteps: {
                    python: [
                        { title: 'Initialize', desc: '결과 리스트와 BFS용 큐를 준비하고, 루트를 큐에 넣는다.', code: 'result = []\nqueue = deque([root])' },
                    ...
                    cpp: [
                        { title: 'Initialize', desc: '결과 벡터와 BFS용 큐를 준비하고, 루트를 큐에 넣는다.', code: 'vector<vector<int>> result;\nqueue<TreeNode*> q;\nq.push(root);' },

...
const stringTopic = {
    ...
    icon: '🔤',
    category: 'Data Structure Applications',
    order: 1,
    ...
    problems: [
        {
            ...
            hints: [
                ...
                },
                {
                    ...
                    content: 'After finding the highest frequency, if <strong>2 or more</strong> letters share that frequency, print <code>?</code>.<br><br>Example: I appears 4 times, S appears 4 times → both are max → print <code>?</code>!'
                }
            ],
            templates: {
                python: `import sys

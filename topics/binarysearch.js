    ...
    problems: [
        {
            ...
            hints: [
                ...
                { title: '근데 이러면 문제가 있어', content: 'N, M이 최대 <strong>100,000</strong>이야. 최악의 경우 100,000 × 100,000 = <strong>100억 번</strong> 비교해야 해.<br>시간 제한 안에 절대 못 끝나! O(N × M)은 너무 느려.' },
        ...
        },
        {
            ...
            hints: [
                ...
                { title: '이렇게 하면 어떨까?', content: '배열을 <strong>정렬</strong>하면 같은 숫자가 <strong>연속으로 모여</strong> 있잖아!<br>그러면 "x가 시작하는 위치"와 "x가 끝나는 다음 위치"만 찾으면 개수 = 끝 위치 - 시작 위치야.<br>이 두 위치를 이분 탐색으로 찾으면 각각 O(log N)이니까 전체 <strong>O((N+M) log N)</strong>으로 충분해!' },
        ...
        },
        {
            ...
            hints: [
                ...
                { title: '근데 이러면 문제가 있어', content: '나무 높이가 최대 <strong>10억</strong>이야! 높이를 0부터 10억까지 1씩 올려가면 최악의 경우 <strong>10억 번</strong> × N개 나무 확인...<br>N도 최대 100만이라 연산 횟수가 어마어마해. 시간 초과 확정이야!' },
        ...
        },
        {
            ...
            hints: [
                ...
                { title: '근데 이러면 문제가 있어', content: 'N이 최대 <strong>200,000</strong>이야. N개 중 C개를 고르는 조합 수는... 상상을 초월해!<br>예를 들어 200,000개 중 100,000개를 고르는 경우의 수? <strong>절대 불가능</strong>한 수준이야.' },
        ...
        },
        {
            ...
            hints: [
                ...
                { title: '근데 이러면 문제가 있어', content: 'N이 최대 <strong>10<sup>5</sup></strong>이야. N² = <strong>10<sup>10</sup></strong>(100억) 개의 수를 배열에 담으면?<br>메모리도 수십 GB 필요하고, 정렬은 더 오래 걸려. <strong>메모리 초과 + 시간 초과</strong> 모두야!' },
        ...
        },
        {
            ...
            hints: [
                ...
                { title: '근데 이러면 문제가 있어', content: 'N이 최대 <strong>1,000,000</strong>(100만)이야! DP의 이중 반복문은 O(N²) = <strong>1조 번</strong> 연산...<br>이건 몇 분이 걸려도 끝나지 않아. 더 빠른 방법이 필요해!' },
